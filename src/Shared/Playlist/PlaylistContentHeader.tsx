...
const PlaylistContentHeader = () => {
    return (
        <Wrapper>
            ...
            <TableHeadSort>
                <TableHeadTitle active={false}>Альбом</TableHeadTitle>
            </TableHeadSort>
            <TableHeadSort>
                <TableHeadTitle active={false}>Дата добавления</TableHeadTitle>
            </TableHeadSort>
            <TableHeadSort>
...
`
export default PlaylistContentHeader;